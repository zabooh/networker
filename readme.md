...
- 🇩🇪 [**Architektur Diagramm (Deutsch)**](docs/ARCHITEKTUR_DIAGRAMM.md) - Detaillierte Diagramme und Datenfluss-Szenarien
- 🇬🇧 [**Architecture Diagram (English)**](docs/ARCHITECTURE_DIAGRAM.md) - Detailed diagrams and data flow scenarios
